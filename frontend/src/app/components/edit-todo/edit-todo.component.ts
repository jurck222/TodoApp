  ...
  template: `
    <div class="modal-header">
      ...
      @if(editMode){
        ...
        <button type="submit" class="btn btn-primary" (click)="updateTodo()">Save todo</button>
      }
      @else {
        <button type="submit" class="btn btn-primary" (click)="switchMode()">Edit todo</button>
      }
		</div>
  `,
  styles: ``
